...
export function GastosPage() {
  ...
  return (
    <div className="min-h-screen">
      ...
      {/* Selector de mes — cabecera prominente */}
      <MonthSelector />
      ...
      <main>
        {isLoading ? (
          ...
          <>
            ...
            <div className="lg:hidden flex flex-col gap-3 p-4 pb-6">
      ...
      {/* FAB — solo en mobile, offset para no solaparse con BottomNav */}
      <div className="lg:hidden" aria-hidden="true">
        <FAB
          isOpen={isFormOpen}
          onClick={() => { setEditingGasto(null); setFormOpen((v) => !v) }}
